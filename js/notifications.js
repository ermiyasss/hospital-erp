...
(function (window) {
    ...
    var EVENTS = {
        ...
        'nurse.task.created':   { type: 'info',    priority: 'high',     category: 'Nursing',  audience: ['admin', 'nurse'] },
        'nurse.task.completed': { type: 'success', priority: 'high',     category: 'Nursing',  audience: ['admin', 'doctor'] },
        'nurse.triage.released': { type: 'info',    priority: 'high',     category: 'Nurse',    audience: ['admin', 'doctor'] },
        'pharmacy.order.created': { type: 'info',  priority: 'normal',   category: 'Pharmacy', audience: ['admin', 'nurse'] },
