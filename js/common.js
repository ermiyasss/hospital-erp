...
(function (window, document) {
    ...
    function navigateTo(target, fallbackTitle) {
        ...
        if (ui && ui.loading) ui.loading(true, 'Opening ' + ((metaForTarget(target) || {}).title || 'page') + '…');
    ...
    if (contentFrame) contentFrame.addEventListener('load', function () {
        if (ui && ui.loading) ui.loading(false);
    });
